...
- [ ] This [demo page](https://cyf-workshop.netlify.app/accessibility-snapshot/)
...
1. Open the [demo page](https://cyf-workshop.netlify.app/accessibility-snapshot/) in Chrome.
