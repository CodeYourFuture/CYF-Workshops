...
{YOUR ANSWERS HERE} a) 42, as the calculate sum function is a + b which gives 42 and has return a + b. b) 42, Undefined. As there's no return it shows the answer but doesn't log it to the console. 