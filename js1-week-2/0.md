...
a) `result1` will evaluate to (42) but the first function will not print anything .
b) `result2` will evaluate to (42) and the second function will print the result out.