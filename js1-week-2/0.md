...
result1 will evaluate to 42

result2 will show undefined as there is not a 'return' value  

logSum shows the result in the console but doesn't return it, calculateSum evaluates and returns the result but doesn't log it in the console
